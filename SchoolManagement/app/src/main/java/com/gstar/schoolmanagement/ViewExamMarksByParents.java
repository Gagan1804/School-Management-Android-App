...
public class ViewExamMarksByParents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_exam_marks_by_parents);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(ViewExamMarksByParents.this, Parent_function.class);
