...
public class ViewTeachersbyStudents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_teachersby_students);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(ViewTeachersbyStudents.this, Student_function.class);
